...
This repository implements Project 5 from [`doc.pdf`](/home/kali/deep/doc.pdf): an explainable intrusion detection system on the NSL-KDD dataset. The pipeline trains three models, generates SHAP and LIME explanations, measures explanation stability, and evaluates a SHAP-guided evasion scenario plus a simple defense.
...
- [`outputs/evasion_heatmap.png`](/home/kali/deep/outputs/evasion_heatmap.png): evasion-rate heatmap.
...
- Variation 3: LIME analysis on attack predictions.
- Security analysis: SHAP-guided evasion and feature-randomization defense.

## Verified Results

Measured by running `./venv/bin/python pipeline.py` on April 27, 2026:

- Logistic Regression: macro F1 `0.7535`, PR-AUC `0.8864`
- Random Forest: macro F1 `0.7726`, PR-AUC `0.9650`
- MLP: macro F1 `0.8060`, PR-AUC `0.9461`
- SHAP stability: Jaccard `0.994 ± 0.037`
- SHAP/MLP importance alignment: Spearman `0.745`
- Best observed evasion rate: `35.49%`
